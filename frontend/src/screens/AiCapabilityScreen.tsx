...
const styles = StyleSheet.create({ container: { flex: 1, backgroundColor: palette.background }, content: { padding: 16, gap: 14 }, card: { borderRadius: 12, padding: 16, backgroundColor: palette.surface, borderWidth: 1, borderColor: palette.border }, available: { borderLeftWidth: 4, borderLeftColor: '#16A34A' }, unavailable: { borderLeftWidth: 4, borderLeftColor: palette.brandYellow }, label: { fontSize: 12, fontWeight: 'bold', color: palette.textSecondary, marginBottom: 8 }, status: { fontSize: 20, fontWeight: 'bold', color: palette.text, marginBottom: 8 }, detail: { fontSize: 14, color: palette.textSecondary, lineHeight: 21 }, warning: { color: palette.brandAmber, lineHeight: 21 }, button: { backgroundColor: palette.deepBlack, padding: 14, borderRadius: 10, alignItems: 'center' }, buttonText: { color: palette.white, fontWeight: 'bold' } });
